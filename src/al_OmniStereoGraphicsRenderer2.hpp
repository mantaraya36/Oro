#ifndef AL_OMNI_STEREO_GRAPHICS_RENDERER2_H
#define AL_OMNI_STEREO_GRAPHICS_RENDERER2_H
...
class OmniStereoGraphicsRenderer2;

struct OmniStereoGraphicsRendererControls2 : InputEventHandler {
  OmniStereoGraphicsRenderer2* o;
  bool onKeyDown(const Keyboard& k);
};

class OmniStereoGraphicsRenderer2 : public Window,
                                    public FPS,
                                    public OmniStereo::Drawable {
 public:
  OmniStereoGraphicsRenderer2();
  virtual ~OmniStereoGraphicsRenderer2();
  ...
  virtual void afterEffect(Graphics& g) {}
 ...
 protected:
  ...
  OmniStereoGraphicsRendererControls2 mOmniControls;
};

inline void OmniStereoGraphicsRenderer2::start() {
...
inline OmniStereoGraphicsRenderer2::~OmniStereoGraphicsRenderer2() {}
...
inline void OmniStereoGraphicsRenderer2::initWindow(const Window::Dim& dims,
...
inline bool OmniStereoGraphicsRenderer2::onCreate() {
  mOmni.onCreate();
...
inline bool OmniStereoGraphicsRenderer2::onFrame() {
  FPS::onFrame();
...
inline void OmniStereoGraphicsRenderer2::onDrawOmni(OmniStereo& omni) {
...
inline std::string OmniStereoGraphicsRenderer2::vertexCode() {
...
inline std::string OmniStereoGraphicsRenderer2::fragmentCode() {
  return R"(
...
inline bool OmniStereoGraphicsRendererControls2::onKeyDown(const Keyboard& k) {
  if (k.key() == 'o') {
